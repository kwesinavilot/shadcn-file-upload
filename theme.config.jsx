        ...
        text: (
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
                ...
                <div style={{ display: 'flex', gap: '10px' }}>
                    ...
                    <a href="https://www.linkedin.com/in/andrews-kwesi-ankomahene" target="_blank" rel="noreferrer" className="nx-p-2 nx-text-current">
