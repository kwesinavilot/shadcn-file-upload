...
const FileUpload = ({
  ...
  // dynamic styling 
  const dropzoneClasses = utils.cn("border-2 border-dashed rounded-lg p-4 text-center cursor-pointer transition-colors", isDragActive ? "border-blue-500 bg-blue-50" : internalErrors || externalErrors ? "border-red-500" : "border-gray-300 hover:border-gray-400", layout === 'horizontal' ? "flex items-center justify-center space-x-4" : "flex flex-col justify-center items-center space-y-2");
   ...
   */
  const renderDropzone = () => /*#__PURE__*/React__default["default"].createElement(React__default["default"].Fragment, null, /*#__PURE__*/React__default["default"].createElement("div", getRootProps({
  ...
  }, otherText)), (internalErrors || externalErrors) && /*#__PURE__*/React__default["default"].createElement("p", {
